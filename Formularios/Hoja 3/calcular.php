...
<!-- Una vez más, comprobaremos los datos que el usuario ha introducido y finalmente los procesaremos para mostrar un resultado
 * a través de un switch iremos pasando por todas las operaciones disponibles y mostraremos el resultado del mismo -->
